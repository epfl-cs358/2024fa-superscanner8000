...
\begin{figure}[H]
    \centering
    \includegraphics[height=0.8\textheight]{images/WiringDiagram.png}
    \caption{Wiring diagram (parts not to scale)}
...
\begin{figure}[H]
    \centering
    \rotatebox{90}{\includegraphics[width=1.3\linewidth]{images/gantt_chart.jpg}}
