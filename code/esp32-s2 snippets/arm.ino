...
float q1 = 0; // angle of lower arm (in radians)
float q2 = 0; // angle of upper arm (in radians)
...
void loop() {
  ...
  */
  ...
  stepper1.moveTo(full_revolution * q1 / (2 * PI));
  stepper2.moveTo(-full_revolution * q2 / (2 * PI));
